...
def pause_plot():
    ...
    try:
        while True:
            ...
            if ground==1:
                grounds.append(t)
                grounds_x.append(xAccl)
                grounds_y.append(yAccl)
                grounds_z.append(zAccl)
                grounds_w.append(w)
